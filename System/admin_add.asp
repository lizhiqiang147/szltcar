...
return true;}
	...
	<td width="85%" class='forumRowHighLight'><input name='username' type='text' id='username' size='30' maxlength="20">（英文或数字，最长<font color="#FF0000" size="+1">&nbsp;20&nbsp;</font>位）
	  &nbsp;</td>
	</tr>
	  <tr>
	    <td class='forumRow' height=23>密码 (必填) </td>
	    <td class='forumRow'><input name='password' type='password' id='password' size='30' maxlength="20">（英文或数字，最长<font color="#FF0000" size="+1">&nbsp;20&nbsp;</font>位）</td>
      </tr>
