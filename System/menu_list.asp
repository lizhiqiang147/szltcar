...
<p>2、不要设置过多导航，可能会导致页面变形。</p>
	    ...
	    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td height="30" class='forumRowHighLight'>&nbsp;| <a href="menu_add.asp">添加新的二级导航</a></td>
          </tr>
          <tr>
            <td height="10"></td>
          </tr>
...
class_style="forumRowHighLight"
          ...
          <tr >
            ...
            <td class='<%=class_style%>' align="center" ><%=rs("name")%><%if rs("image")<>"" then%>&nbsp;[<span style="color: #FF0000">图</span>]<%end if%></td>
