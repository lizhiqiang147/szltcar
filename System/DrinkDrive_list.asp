...
<table cellpadding='3' cellspacing='1' border='0' class='tableBorder' align="center">
    <tr>
        <th width="100%" height="25" class='tableHeaderText'>酒后代驾</th>
        ...
        <tr>
            <td height="400" valign="top" class='forumRow'>
                ...
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="25" class='forumRowHighLight'>&nbsp;| <a href="DrinkDrive_add.asp?juhaoyong_cid=<%=juhaoyong_cid%>&juhaoyong_pid=<%=juhaoyong_pid%>&juhaoyong_ppid=<%=juhaoyong_ppid%>">添加新的文章</a></td>
                    </tr>
                ...
                <form name="form2" method="post" action="info_Del.asp?action=AllDel&juhaoyong_cid=<%=juhaoyong_cid%>&juhaoyong_pid=<%=juhaoyong_pid%>&juhaoyong_ppid=<%=juhaoyong_ppid%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
                        ...
                        <% '文章列表模块
strFileName="DrinkDrive_list.asp" 
pageno=25
