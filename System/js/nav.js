...
var t;
t=outlookbar.addtitle('关于程序','后台首页',1)
outlookbar.additem('关于程序',t,'version.asp')




t=outlookbar.addtitle('网站设置','系统设置',1)
outlookbar.additem('基本信息',t,'web_settings.asp')

t=outlookbar.addtitle('首页轮播图片','系统设置',1)
outlookbar.additem('首页轮播图片管理',t,'ads_list.asp')
...
t=outlookbar.addtitle('后台用户','系统设置',1)
outlookbar.additem('后台用户管理',t,'admin_list.asp')
...
outlookbar.additem('顶部一级导航',t,'menu_type_list.asp')
outlookbar.additem('顶部二级导航',t,'menu_list.asp')
outlookbar.additem('底部导航',t,'menuBottom_list.asp')
