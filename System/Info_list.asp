...
<table cellpadding='3' cellspacing='1' border='0' class='tableBorder' align="center">
    <tr>
        <th width="100%" height="25" class='tableHeaderText'>价格列表</th>
        ...
        <tr>
            <td height="400" valign="top" class='forumRow'>
                ...
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        <td height="30" valign="top" class="TipWords">
                            <p>1、价格列表显示您所添加的所有价格，标示“未审核”的价格将不会在网站中显示。</p>
                            <p>2、删除价格将会同步删除数据库中的记录和价格的具体地址请慎重。</p>
                        </td>
                    </tr>
                    <tr>
                        <td height="10"></td>
                ...
                <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                        <td height="25" class='forumRowHighLight'>&nbsp;| <a href="info_add.asp?juhaoyong_cid=<%=juhaoyong_cid%>&juhaoyong_pid=<%=juhaoyong_pid%>&juhaoyong_ppid=<%=juhaoyong_ppid%>">添加新的价格</a></td>
                    </tr>
                    ...
                    <table width="95%" border="0" align="center" cellpadding="0" cellspacing="2">
                        <tr>
                            ...
                            <td width="31%" height="30" class="TitleHighlight">
                                <div align="center" style="font-weight: bold; color: #ffffff">价格标题</div>
                            </td>
                            ...
                            <td width="8%" class="TitleHighlight">
                                <div align="center" style="font-weight: bold; color: #ffffff">价格操作</div>
                            </td>
                        </tr>
                        <% '价格列表模块
...
class_style="forumRowHighLight"
                        ...
                        <tr>
                            ...
                            <td class='<%=class_style%>'>
                                <div align="center"><a href="info_edit.asp?id=<%=rs("id")%>&juhaoyong_cid=<%=juhaoyong_cid%>&juhaoyong_pid=<%=juhaoyong_pid%>&juhaoyong_ppid=<%=juhaoyong_ppid%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>">修改</a> | <a href="javascript:if(ask('警告：删除后将不可恢复，确定要删除吗？')) location.href='info_del.asp?id=<%=rs("id")%>&juhaoyong_cid=<%=juhaoyong_cid%>&juhaoyong_pid=<%=juhaoyong_pid%>&juhaoyong_ppid=<%=juhaoyong_ppid%>&page=<%=page%>&act=<%=act%>&keywords=<%=keywords%>';">删除</a>            </div>
                            </td>
                        </tr>
                        <%
		  rs.movenext
...
response.write "<div align='center'><span style='color: #FF0000'>暂无价格！</span></div>"
		  end if 
		  rs.close
		  set rs=nothing
                        %>
