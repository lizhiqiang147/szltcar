...
%>
	...
	<tr>
	  <th width="100%" height=25 class='tableHeaderText'>É¾³ýÍ¼Æ¬</th>
...
call index_to_html()
response.Write "<script language='javascript'>alert('É¾³ý³É¹¦£¡');location.href='ads_list.asp?page="&page&"&act="&act&"&keywords="&keywords&"';</script>"
			%></td>
          </tr>
        </table>
	    </td>
